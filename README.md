...
База данных создается с помощью SQlite. Импорты классов виджетов происходят из файла Widgets.py. В файлах также имеется копия
этого туториала (называется Readme_PYQT5).
